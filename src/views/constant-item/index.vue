<template>
  <div>
    <el-row :gutter="10">
      <el-col :span="5">
        <el-input v-model="search.name" placeholder="请输入要查的常数类型名称"></el-input>
      </el-col>
      <el-col :span="19">
    ...
    <el-table :data="result.tableData" style="width: 100%" @selection-change="handleSelectionChange" @select="selectRow">
      ...
      <el-table-column label="常数项类型"  prop="typeName">
      </el-table-column>
...
<script>
  import ConstantItemEdit from '@/views/constant-item/edit'
